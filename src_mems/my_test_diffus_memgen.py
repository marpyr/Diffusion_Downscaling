...
# I take the path of training with all_mems and I run inference to generate new mems

num_ensemble=10
best_model_path = "/.../Model_dif/norm_Test_4/best_model.pt"
ifs_dir = '/.../mpydownscaling/DATA/'
obs_dir = '/.../mpydownscaling/DATA/'
mask_path = '/.../mpydownscaling/DATA/TabsD_mask_static.nc'
results_dir = "/.../Results_dif/norm_Test_4_memgen/test_predictions"
...
# Save results
# -------------------------------
save_path = os.path.join(results_dir, "predictions_test4_set.npz")
np.savez_compressed(
    save_path,
    coarse=all_coarse,
    fine=all_fine,

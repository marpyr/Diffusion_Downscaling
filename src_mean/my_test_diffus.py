...
# -------------------------------
num_ensemble=50
best_model_path = f"/.../Model_dif/ensmean_Test_4/monthday_{month}/best_model.pt"
ifs_dir = '/.../mpydownscaling/DATA/'
obs_dir = '/.../mpydownscaling/DATA/'
mask_path = '/.../mpydownscaling/DATA/TabsD_mask_static.nc'
results_dir = f"/.../Results_dif/ensmean_Test_4/monthday_{month}/test_predictions"
...
# Save results
# -------------------------------
save_path = os.path.join(results_dir, "predictions_test4_50members.npz")
np.savez_compressed(
    save_path,
    coarse=all_coarse,
    fine=all_fine,
